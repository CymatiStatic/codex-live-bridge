## API Reference[<svg aria-hidden="true" focusable="false" data-prefix="far" data-icon="link" class="svg-inline--fa fa-link fa-2xs " role="img" xmlns="http://www.w3.org/2000/svg" viewbox="0 0 640 512"><path fill="currentColor" d="M580.3 267.2c56.2-56.2 56.2-147.3 0-203.5C526.8 10.2 440.9 7.3 383.9 57.2l-6.1 5.4c-10 8.7-11 23.9-2.3 33.9s23.9 11 33.9 2.3l6.1-5.4c38-33.2 95.2-31.3 130.9 4.4c37.4 37.4 37.4 98.1 0 135.6L433.1 346.6c-37.4 37.4-98.2 37.4-135.6 0c-35.7-35.7-37.6-92.9-4.4-130.9l4.7-5.4c8.7-10 7.7-25.1-2.3-33.9s-25.1-7.7-33.9 2.3l-4.7 5.4c-49.8 57-46.9 142.9 6.6 196.4c56.2 56.2 147.3 56.2 203.5 0L580.3 267.2zM59.7 244.8C3.5 301 3.5 392.1 59.7 448.2c53.6 53.6 139.5 56.4 196.5 6.5l6.1-5.4c10-8.7 11-23.9 2.3-33.9s-23.9-11-33.9-2.3l-6.1 5.4c-38 33.2-95.2 31.3-130.9-4.4c-37.4-37.4-37.4-98.1 0-135.6L207 165.4c37.4-37.4 98.1-37.4 135.6 0c35.7 35.7 37.6 92.9 4.4 130.9l-5.4 6.1c-8.7 10-7.7 25.1 2.3 33.9s25.1 7.7 33.9-2.3l5.4-6.1c49.9-57 47-142.9-6.5-196.5c-56.2-56.2-147.3-56.2-203.5 0L59.7 244.8z"></path></svg>](https://docs.cycling74.com/userguide/#api-reference)
...
- [JavaScript API](https://docs.cycling74.com/apiref/js/): Use the [v8](https://docs.cycling74.com/reference/v8/ "v8"), [v8ui](https://docs.cycling74.com/reference/v8ui/ "v8ui") and [v8.codebox](https://docs.cycling74.com/reference/v8.codebox "v8.codebox") to embed JavaScript in a Max patch. Define custom objects, programmatically create objects and patch cords, and operate the Max application.
- [Live Object Model](https://docs.cycling74.com/apiref/lom/): Use Max objects like [live.object](https://docs.cycling74.com/reference/live.object "live.object") and [live.path](https://docs.cycling74.com/reference/live.path "live.path") to read and modify the state of Ableton Live from within a Max for Live device. Also accessible from the JavaScript API.
- [Node for Max](https://docs.cycling74.com/apiref/nodeformax/): Use the [node.script](https://docs.cycling74.com/reference/node.script "node.script") and [node.debug](https://docs.cycling74.com/reference/node.debug "node.debug") objects to launch custom Node.js scripts from Max. Send Max messages to a running Node process and fetch a result.#!/usr/bin/env python3
"""
